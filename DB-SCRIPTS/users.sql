...
VALUES
  ('Erhan Baş', 'erhan.bas@site.com', 'Admin123!', true, 1, '1988-03-14', NOW());

-- ADMIN (3)
INSERT INTO users (name, email, password, is_active, role, birthdate, created_at)
VALUES
  ('Selin Kaya', 'selin.kaya@site.com', 'Admin456!', true, 2, '1990-01-10', NOW()),
  ('Ahmet Demir', 'ahmet.demir@site.com', 'Admin789!', false, 2, '1985-09-22', NOW()),
  ('Burcu Yılmaz', 'burcu.yilmaz@site.com', 'Admin321!', true, 2, '1993-06-05', NOW());
...
INSERT INTO users (name, email, password, is_active, role, birthdate, created_at)
VALUES
  ('Sena Ekinci', 'sena.ekinci@site.com', 'Sell123!', true, 4, '1987-07-14', NOW()),
  ('Mehmet Uzun', 'mehmet.uzun@site.com', 'Sell234!', true, 4, '1992-08-22', NOW()),
  ('Elif Aras', 'elif.aras@site.com', 'Sell345!', true, 4, '1995-01-17', NOW()),
  ('Cihan Koç', 'cihan.koc@site.com', 'Sell456!', true, 4, '1989-11-03', NOW()),
  ('Fatma Er', 'fatma.er@site.com', 'Sell567!', true, 4, '1994-02-25', NOW()),
  ('Serdar Kılıç', 'serdar.kilic@site.com', 'Sell678!', false, 4, '1988-06-10', NOW());

-- GUEST (1)
INSERT INTO users (name, email, password, is_active, role, birthdate, created_at)
VALUES
  ('Misafir Kullanıcı', 'guest@site.com', 'Guest123!', false, 5, '2005-01-01', NOW());